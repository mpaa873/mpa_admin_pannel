        ...
        <div className="bg-slate-900/50 backdrop-blur-2xl border border-slate-800 p-8 rounded-[2rem] shadow-2xl">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-2xl font-extrabold text-white tracking-tight mb-2">
              MPA <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Admin</span>
            </h1>
          ...
          <p className="text-center mt-8 text-sm text-slate-500">
            System Security Protocol Active <span className="text-green-500 ml-1">●</span>
          </p>
        </div>
      </div>
    </div>
